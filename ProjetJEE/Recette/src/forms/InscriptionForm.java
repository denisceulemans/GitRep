...
public final class InscriptionForm 
{
    ...
    private void validMdp(String mdp, String confirmation) throws Exception 
    {
        if (mdp != null && confirmation != null) {
            ...
            {
                throw new Exception("Les mots de passe diffèrent");
            } 
            else if (mdp.length() < 5) 
            {
                throw new Exception("Le nombre de caractères du mot de passe doit être entre 5 et 20");
            }
        } 
        else 
        {
    ...
    private void validLogin(String login) throws Exception 
    {
    	if (login != null) 
    	{
            if (login.length() < 5) 
            {
                throw new Exception("Le nombre de caractères du login doit être entre 5 et 20");
            }
        } 
    	else 
    	{
