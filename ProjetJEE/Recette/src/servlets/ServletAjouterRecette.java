...
public class ServletAjouterRecette extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
        ...
        {
        	request.setAttribute("recette", new Recette());
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
        ...
        else
        {
			...
			if(request.getParameter("ajouterrecette") != null)
			{
	        	...
	        	{
	        		request.setAttribute("recette",form.lireRecette(request));
			...
			else
			{
				...
				for(int i=0;i<listeIngredient.size();i++)
				{
					...
					{
						listeIngredient.remove(i);
					}
				}
				for(int i=0;i<listeEtape.size();i++)
				{
					//supprimer l'étape i
					if(request.getParameter("supprimeEtape"+i) !=null)
					{
						listeEtape.remove(i);
					}
				}
